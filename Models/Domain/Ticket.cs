...
public class Ticket
{
	...
	public Ticket(Guid id ,DateTime date , bool isclosed , Severity s, string d ,List<Developer> developers,Department dep)
	{
		Id= id;
		CreatedDate = date;
		IsClosed= isclosed;
